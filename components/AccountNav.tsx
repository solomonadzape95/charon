...
export function AccountNav() {
  ...
  const studioView =
    isStudioPath(pathname) || (mode === "studio" && pathname === "/profile");
  ...
  return (
    ...
    >
      <div className="mx-auto flex max-w-5xl items-center gap-4 px-6 py-3.5">
        <Link
          href={
            signedIn ? (studioView ? "/creator/studio" : "/dashboard") : "/"
          }
        ...
        >
          ...
          />
          Search…
          <kbd className="pointer-events-none absolute right-2.5 top-1/2 hidden -translate-y-1/2 rounded border border-border bg-bg px-1.5 py-0.5 text-[0.62rem] font-medium md:block">
            ⌘K
          </kbd>
        </button>
          ...
          {ready && signedIn ? (
            <>
              ...
              >
                ...
                <span className="hidden max-w-[8rem] truncate text-sm text-[var(--color-ink)] md:inline">
                  {username}
                </span>
              </Link>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2.5">
              ...
              <button
                ...
                aria-label="Sign out"
                title="Sign out"
                className="grid h-9 w-9 place-items-center rounded-full border border-[var(--color-border)] text-[var(--color-muted)] hover:text-[var(--color-ink)]"
              >
                <LogOut size={15} />
              </button>
            </div>
            ...
            return (
              <Link
                ...
                className={`relative whitespace-nowrap rounded-full px-4 py-1.5 text-utility transition-colors ${
                  active
                    ? "bg-[color-mix(in_srgb,var(--color-gold)_14%,transparent)] text-coin"
