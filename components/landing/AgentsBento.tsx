...
import { Bot, Tag, LineChart, Wallet } from "lucide-react";

// PNGs (dropped in /public/agents) replace the lucide fallbacks when present.
const TILES = [
  { n: "I", icon: Bot, png: "/agents/reader.png", name: "Autonomous Reader Agent", body: "Holds a weekly budget and its own on-chain wallet — discovers, judges, and pays for chapters you'll love, entirely on its own." },
...
function AgentIcon({ png, Icon }: { png: string; Icon: typeof Bot }) {
